package com.example.workfitv08;
...
//        };
    ...
    private void stopRecordingVideo() {
        ...
        for(int i = imageOffset ; i <= microTime ; i = i+imageOffset){
            ...
            currentBytes[index] = baos.toByteArray();
            Log.d("Image Bytes:{}", String.valueOf(currentBytes[index]));
            index++;
        }
...
//    }
    ...
    public void connect(byte[][] currentBytes, AppCompatActivity mActivity) {
...
//                    Log.d(TAG, "input: " + socket.getInputStream());
                ...
                try {
                    for(int i = 0 ; i < 32 ; i++){
                        Log.d("currentByte Length:{}", String.valueOf(currentBytes[0].length));
                        dos.writeUTF(String.valueOf(currentBytes[0].length));
                        dos.flush();

                        Log.d("currentBytes:{}", String.valueOf(currentBytes[0]));
                        dos.write(currentBytes[0]);
                        dos.flush();
                    }
